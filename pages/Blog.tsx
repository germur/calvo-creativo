...
const Blog = () => {
  const posts = [
    { track: '04', title: 'El SEO no murió: humo, modas y lo que sí funciona', category: 'Estrategia', time: '10:00 READ', traffic: 'HOT', link: '/liner-notes/seo-no-murio-humo' },
    { track: '01', title: 'Cómo llevamos a Retail Giant de 0 a 100k visitas', category: 'Casos de Éxito', time: '5:00 READ', traffic: 'HOT', link: '#' },
    { track: '02', title: 'El Knockout Técnico: Recuperación de penalización', category: 'Guías Técnicas', time: '7:12 READ', traffic: 'STEADY', link: '#' },
    { track: '03', title: 'SEO Local: Dominando el Octágono de Maps', category: 'Casos de Éxito', time: '4:20 READ', traffic: 'RISING', link: '#' },
  ];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col border-2 border-ink bg-white/50">
            {posts.map((post, idx) => (
              <Link to={post.link} key={idx} className="group flex flex-col md:flex-row border-b border-ink/10 last:border-0 hover:bg-primary/5 transition-colors p-6 gap-6 items-center">
